  ...
  return (
    <section className="container mx-auto py-16 flex flex-col md:flex-row gap-10 md:gap-0 items-center justify-between animate-fade-in-right">
      <div className="flex flex-col items-center md:items-start gap-y-2 md:gap-y-7">
        <h1 className="font-syne font-bold text-[36px] text-center sm:text-start sm:text-[50px] md:text-[56px] text-white">
          <span className="text-primary">Conoce</span> a los jugadores
        </h1>

        <p className="max-w-2xl px-5 md:px-0 font-raliway font-bold text-paragraph text-sm sm:text-base text-pretty leading-7 tracking-widest">
          ¿Quieres saber más sobre los jugadores de tus equipos favoritos?
          Explora nuestras listas de equipos y conoce a los miembros del roster.
          Descubre a los héroes detrás de cada juego y sigue sus carreras en
          tiempo real.
          <br />
          <br />
          ¡Haz clic en <span className="text-primary">Ver Equipos</span> para
          comenzar!
        </p>
