...
const CTA = () => {
  return (
    <section className='container mx-auto py-16 flex flex-row items-center justify-between animate-fade-in-right'>
        <div className="flex flex-col gap-y-7">
            <h1 className='font-syne font-bold text-[56px] text-white'><span className='text-primary'>Conoce</span> a los jugadores</h1>

            <p className='max-w-2xl font-raliway font-bold text-paragraph leading-7 tracking-widest'>
        ...
        <div className="right">
            <div className="absolute size-[350px] object-cover border-2 border-primary p-2 rounded-full animate-poped"></div>
            <img src={jugador} alt="Jugador" width={320} height={320} 
            className='size-[350px] object-cover  rounded-full' />
        </div> 
    </section>
  )
}
