...
import {Cubs, Yankees } from "../assets";
                    ...
                    <div className="flex flex-row items-baseline justify-center gap-x-4 md:gap-x-12">
                        ...
                        {/* <Link to={`/team/${game.teams?.away?.team?.id}`}>  */}
                            <div className="flex flex-col gap-4 items-center">
                                ...
                                <h2 className='font-raleway text-white text-xs md:text-[18px] text-center font-bold leading-[25px]'>{game.teams?.away?.team?.name}</h2>
                            </div>  
                        {/* </Link>  */}
                        ...
                        <div className="flex flex-col items-center">    
                            ...
                            <div className="flex flex-col gap-4 items-center">
                                ...
                                <h2 className='font-raleway text-white text-xs md:text-[18px] text-center font-bold leading-[25px]'>{game.teams?.home?.team?.name}</h2>
                            </div> 
                            {/* </Link>  */}            
